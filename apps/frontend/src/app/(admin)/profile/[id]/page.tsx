...
import { ArrowLeft, Mail, Phone, User, Building2, Shield, Calendar, UserCheck } from 'lucide-react';
      ...
      {isError && (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
          <ErrorAlert
            ...
            message={error ? 'User not found or an error occurred' : 'Unknown error'}
          />
        </div>
      )}
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm font-medium">
                        {typeof user.department === 'string'
                          ? user.department
                          : user.department.departmentName || user.department.departmentCode || '—'}
                      </p>
                    </div>
                  )}
