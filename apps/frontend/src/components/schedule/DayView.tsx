                      ...
                      <div className="ml-2 flex items-center justify-between gap-4">
                        <div>
                          ...
                          <div className="flex items-center space-x-1 text-xs text-gray-600">
                            ...
                            <span>
                              {slotSchedules[0].actual_start_time} -{" "}
                              {slotSchedules[0].actual_end_time}
                            </span>
                            <span className="text-gray-500">•</span>
                            <span className="text-gray-500">
                              {slotSchedules[0].room?.roomCode ||
                                "Consultation"}
                            </span>
                          </div>
                        </div>
                        <Badge
                          className={`${getStatusColor(
                            slotSchedules[0].schedule_status
                          )} border border-blue-400 text-xs ml-auto`}
                        >
                          {slotSchedules[0].schedule_status
                            .charAt(0)
                            .toUpperCase() +
                        ...
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            ...
                            <p className="text-xs text-gray-600">
                              {slotSchedules[0].room?.roomCode || "Room"} •{" "}
                              {slotSchedules[0].actual_start_time}
                            </p>
                          </div>
