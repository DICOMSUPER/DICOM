    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={modalStyles.dialogContent}>
        ...
        <DialogHeader className={modalStyles.dialogHeader}>
          <DialogTitle className={modalStyles.dialogTitle}>Request Procedure Details</DialogTitle>
        </DialogHeader>
            ...
            {procedure.description && (
              <section className={modalStyles.section}>
                ...
                <div className={modalStyles.infoCard}>
                  <p className={modalStyles.infoCardValue}>{procedure.description}</p>
                </div>
              </section>
            )}
        ...
        <DialogFooter className={modalStyles.dialogFooter}>
          ...
          {onEdit && procedure && (
            <Button onClick={() => onEdit(procedure)} className={modalStyles.primaryButton}>
              Edit Procedure
            </Button>
          )}
        </DialogFooter>
