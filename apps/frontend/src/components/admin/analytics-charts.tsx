        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={encountersByType}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="count" fill="#8884d8" name="Count" radius={[8, 8, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
      ...
      {departmentsDistribution.length > 0 && (
        <Card className="border-0 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Room distribution across departments</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={departmentsDistribution}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="count" fill="#8884d8" name="Rooms" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
