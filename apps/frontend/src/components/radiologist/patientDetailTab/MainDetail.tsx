...
export interface MedicalRecordMainProps {
    selectedExam: string
}

const MedicalRecordMain: React.FC<MedicalRecordMainProps> = ({ selectedExam }) => {
    return (
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm leading-relaxed">
                                Hình ảnh túi phình không lồ động mạch cảnh trong phải đoạn cuối xoang hang (ngang mức xuất phát ĐM mắt).
                                Ổ tồn thương cũ thùy trán phải.
                            </p>
                        </div>
