      ...
      <div className="bg-white border-b border-gray-300 p-4 space-y-3">
        ...
        {advancedToggled && (
          <div className="flex flex-wrap gap-3 items-end pt-2 border-t border-gray-200">
            <div className="flex flex-col gap-1 min-w-[180px] flex-1 max-w-[250px]">
              <Label className="text-xs font-semibold text-gray-700">
                Study UID
              </Label>
              <Input
            ...
            <div className="flex flex-col gap-1">
              <Label
                ...
                title="Study creation date, generated by the dicom file's metadata from the modality machine"
              >
                Study Date From
              </Label>
              <div className="flex items-center gap-2">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke={startDate === undefined ? "gray" : "red"}
                  strokeWidth="2"
                  strokeLinecap="round"
