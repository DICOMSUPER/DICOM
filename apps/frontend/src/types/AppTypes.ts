  ...
  namespace AppTypes {
    ...
    export namespace HangingProtocol {
      ...
      export type ViewportMatchDetails =
        HangingProtocolTypes.ViewportMatchDetails;
      export type DisplaySetMatchDetails =
        HangingProtocolTypes.DisplaySetMatchDetails;
      export type DisplaySetAndViewportOptions =
        HangingProtocolTypes.DisplaySetAndViewportOptions;
      ...
      export type HangingProtocolMatchDetails =
        HangingProtocolTypes.HangingProtocolMatchDetails;
      ...
      export type ViewportLayoutOptions =
        HangingProtocolTypes.ViewportLayoutOptions;
      ...
      export type ProtocolNotifications =
        HangingProtocolTypes.ProtocolNotifications;
    ...
    export namespace PanelModule {
      ...
      export type ActivatePanelTriggers =
        PanelModuleTypes.ActivatePanelTriggers;
