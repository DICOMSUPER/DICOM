...
export class PatientConditionController {
  ...
  constructor(
    private readonly patientConditionService: PatientConditionService
  ) {}
  ...
  async update(
    ...
    try {
      ...
      return await this.patientConditionService.update(
        id,
        updatePatientConditionDto
      );
    } catch (error) {
  ...
  async findByPatientId(
    ...
    try {
      ...
      return await this.patientConditionService.findByPatientId(
        patientId,
        paginationDto
      );
    } catch (error) {
      throw handleErrorFromMicroservices(
        error,
        'Failed to find patient conditions by patient ID',
        PATIENT_SERVICE
      );
    }
  }
